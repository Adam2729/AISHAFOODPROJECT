...
function normalizeDriverOffer(offer) {
  ...
  return {
    ...
    restaurantPhone: firstText([offer.restaurantPhone, offer.contact?.businessPhone]) || null,
    pickupAddress: firstText([offer.pickupAddress, offer.restaurantAddress]),
    customerName: firstText([offer.customerName], "Customer"),
    customerPhone: firstText([offer.customerPhone, offer.contact?.customerPhone]) || null,
