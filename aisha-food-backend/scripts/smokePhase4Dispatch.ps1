...
Write-Host "Running Phase-4 dispatch smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase4Dispatch.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-4 dispatch smoke completed successfully." -ForegroundColor Green
