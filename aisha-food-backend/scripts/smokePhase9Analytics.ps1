...
Write-Host "Running Phase-9 analytics smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase9Analytics.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-9 analytics smoke completed successfully." -ForegroundColor Green
