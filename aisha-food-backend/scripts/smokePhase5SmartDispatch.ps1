...
Write-Host "Running Phase-5 smart dispatch smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase5SmartDispatch.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-5 smart dispatch smoke completed successfully." -ForegroundColor Green
