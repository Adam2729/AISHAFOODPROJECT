...
Write-Host "Running finance alerts smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:finance-alerts
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Finance alerts smoke completed successfully." -ForegroundColor Green
