...
Write-Host "Running Phase-3 analytics ops smoke against $normalizedBase (mode=$Mode) ..." -ForegroundColor Cyan
& node scripts/smokePhase3AnalyticsOps.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-3 analytics ops smoke completed successfully." -ForegroundColor Green
