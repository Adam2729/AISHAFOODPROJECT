...
Write-Host "Running Phase-8 growth smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase8Growth.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-8 growth smoke completed successfully." -ForegroundColor Green
