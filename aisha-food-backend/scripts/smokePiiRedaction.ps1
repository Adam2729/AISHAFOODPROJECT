...
Write-Host "Running PII redaction smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:pii
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "PII redaction smoke completed successfully." -ForegroundColor Green
