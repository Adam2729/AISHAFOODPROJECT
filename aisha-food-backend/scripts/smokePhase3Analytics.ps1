...
Write-Host "Running Phase-3 analytics smoke against $normalizedBase (mode=$Mode) ..." -ForegroundColor Cyan
& node scripts/smokePhase3Analytics.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-3 analytics smoke completed successfully." -ForegroundColor Green
