...
Write-Host "Running Phase-3 driver ops smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase3DriverOps.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-3 driver ops smoke completed successfully." -ForegroundColor Green
