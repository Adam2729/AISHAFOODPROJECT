...
Write-Host "Running Phase-10 incentives smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase10Incentives.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-10 incentives smoke completed successfully." -ForegroundColor Green
