...
Write-Host "Running Phase-11 loyalty smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase11Loyalty.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-11 loyalty smoke completed successfully." -ForegroundColor Green
