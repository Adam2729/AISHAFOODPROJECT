...
Write-Host "Running Phase-6 ordering smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase6Ordering.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-6 ordering smoke completed successfully." -ForegroundColor Green
