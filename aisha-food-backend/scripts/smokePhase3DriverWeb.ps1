...
Write-Host "Running Phase-3 driver web smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase3DriverWeb.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-3 driver web smoke completed successfully." -ForegroundColor Green
