...
Write-Host "Running promo budget smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:promo-budget
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Promo budget smoke completed successfully." -ForegroundColor Green
