...
Write-Host "Running Phase-3 bulk pay smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase3BulkPay.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-3 bulk pay smoke completed successfully." -ForegroundColor Green
