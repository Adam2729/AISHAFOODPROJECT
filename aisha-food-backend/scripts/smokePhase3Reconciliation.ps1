...
Write-Host "Running Phase-3 reconciliation smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase3Reconciliation.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-3 reconciliation smoke completed successfully." -ForegroundColor Green
