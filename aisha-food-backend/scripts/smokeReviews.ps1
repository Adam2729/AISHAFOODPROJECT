...
Write-Host "Running review smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:reviews
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Review smoke completed successfully." -ForegroundColor Green
