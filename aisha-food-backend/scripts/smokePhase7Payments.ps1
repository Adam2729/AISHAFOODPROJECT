...
Write-Host "Running Phase-7 payments smoke against $normalizedBase ..." -ForegroundColor Cyan
& node scripts/smokePhase7Payments.js
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Phase-7 payments smoke completed successfully." -ForegroundColor Green
