...
export const DISPATCH_ASSIGNABLE_STATUSES = [
  "accepted",
  "preparing",
  "ready",
  "out_for_delivery",
...
export type DispatchAssignableStatus = (typeof DISPATCH_ASSIGNABLE_STATUSES)[number];
...
export function isDispatchAssignableStatus(value: string): value is DispatchAssignableStatus {
  return DISPATCH_ASSIGNABLE_STATUSES.includes(value as DispatchAssignableStatus);
}
