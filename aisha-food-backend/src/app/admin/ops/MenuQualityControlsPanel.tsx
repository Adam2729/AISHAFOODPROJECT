...
export default function MenuQualityControlsPanel({
  ...
  async function saveSettings() {
    ...
    try {
      await Promise.all([
        postJson(`/api/admin/settings/number`, {
        ...
        postJson(`/api/admin/settings/bool`, {
  ...
  async function runRecomputeNow() {
    ...
    setSuccess("");
    try {
      await postJson(`/api/admin/jobs/menu-quality-recompute`, {});
  ...
  async function runAutoHideNow() {
    ...
    setSuccess("");
    try {
      await postJson(`/api/admin/jobs/auto-hide-products`, {});
  ...
  async function pauseBusinessForLowQuality(businessId: string) {
    ...
    setSuccess("");
    try {
      await postJson(`/api/admin/businesses/pause`, {
        businessId,
        paused: true,
