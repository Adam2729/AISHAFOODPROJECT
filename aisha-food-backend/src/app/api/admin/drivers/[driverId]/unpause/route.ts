...
export async function POST(
  ...
  try {
    ...
    await OpsDriverAudit.create({
      ...
      driverId: driver._id,
      action: "DRIVER_UNPAUSED",
      actorAdminId: null,
      meta: { reason: null, before, after: { pausedAt: null, pausedReason: null } },
    });
    ...
    return fail(err.code || "SERVER_ERROR", err.message || "Could not unpause driver.", err.status || 500);
  }
}
