  ...
  try {
    ...
    return new Response(lines.join("\n"), {
      ...
      headers: {
        ...
        "content-disposition": `attachment; filename="rider-payouts_driver_${driverId}_${safeWeek}_${safeStatus}.csv"`,
    ...
    return fail(
      ...
      err.message || "Could not export driver/week rider payouts.",
      err.status || 500
    );
  }
}
