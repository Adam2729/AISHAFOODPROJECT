...
Write-Host "Running delivery OTP smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:delivery-otp
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Delivery OTP smoke completed successfully." -ForegroundColor Green
