...
Write-Host "Running finance alignment smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:finance-align
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Finance alignment smoke completed successfully." -ForegroundColor Green
