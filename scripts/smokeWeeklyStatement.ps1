...
Write-Host "Running weekly statement smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:statement
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Weekly statement smoke completed successfully." -ForegroundColor Green
