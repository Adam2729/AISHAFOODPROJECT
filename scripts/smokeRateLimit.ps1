...
Write-Host "Running rate-limit smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:rate-limit
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Rate-limit smoke completed successfully." -ForegroundColor Green
