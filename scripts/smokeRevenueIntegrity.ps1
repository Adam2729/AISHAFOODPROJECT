...
Write-Host "Running Step 9 integrity smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:integrity
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Step 9 integrity smoke completed successfully." -ForegroundColor Green
