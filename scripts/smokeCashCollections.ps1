...
Write-Host "Running cash collections smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:cash-collections
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Cash collections smoke completed successfully." -ForegroundColor Green
