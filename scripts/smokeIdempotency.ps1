...
Write-Host "Running idempotency smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:idempotency
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Idempotency smoke completed successfully." -ForegroundColor Green
