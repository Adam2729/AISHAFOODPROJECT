...
Write-Host "Running driver cash smoke against $normalizedBase ..." -ForegroundColor Cyan
& npm run qa:smoke:driver-cash
if ($LASTEXITCODE -ne 0) {
  exit $LASTEXITCODE
}

Write-Host "Driver cash smoke completed successfully." -ForegroundColor Green
